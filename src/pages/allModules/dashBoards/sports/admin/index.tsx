...
import { SPORTS_COMPANY_ADMIN_SUBJECT } from 'src/configs/aclSubjects'
...
const ACLPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      {customAbility.can([], SPORTS_COMPANY_ADMIN_SUBJECT, ability) ? (
        <Grid item md={6} xs={12}>
          <Card>
            <CardHeader title='Sports Company Admin' />
            <CardContent>
