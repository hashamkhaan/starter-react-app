...
import { TRAVEL_COMPANY_ADMIN_SUBJECT, ACCOUNTS_SUBJECT } from 'src/configs/aclSubjects'
...
const ACLPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      {customAbility.can([], TRAVEL_COMPANY_ADMIN_SUBJECT, ability) ? (
        <Grid item md={6} xs={12}>
          <Card>
            <CardHeader title='Travel Company Admin' />
            <CardContent>
