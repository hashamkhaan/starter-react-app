...
import { fetchDataById } from 'src/store/apps/general/branch'
...
const DialogEditUserInfo = ({ itemId, openEdit, setOpenEdit }) => {
  ...
  const dataEdit = useSelector((state: RootState) => state.branches.dataById)
  const dataByIdLoading = useSelector((state: RootState) => state.branches.dataByIdLoading)
  ...
  return (
    ...
    >
      ...
      >
        Edit Branch Information {itemId}
      </DialogTitle>
