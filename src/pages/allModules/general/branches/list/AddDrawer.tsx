...
const SidebarAddUser = (props: SidebarAddUserType) => {
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h6'>Add Root Branch</Typography>
      ...
      <Box sx={{ p: 5 }}>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl fullWidth sx={{ mb: 6 }}>
            <InputLabel id='cityId-select'>Select City</InputLabel>
            <Controller
              name='cityId'
              control={control}
              render={({ field: { value, onChange } }) => (
            ...
            />
            {errors.cityId && <FormHelperText sx={{ color: 'error.main' }}>{errors.cityId.message}</FormHelperText>}
          </FormControl>
