...
// ** Demo Components
import Teams from 'src/pages/allModules/general/users/user-profile/teams'
import Profile from 'src/pages/allModules/general/users/user-profile/profile'
import Projects from 'src/pages/allModules/general/users/user-profile/projects'
import Connections from 'src/pages/allModules/general/users/user-profile/connections'
import UserProfileHeader from 'src/pages/allModules/general/users/user-profile/UserProfileHeader'
