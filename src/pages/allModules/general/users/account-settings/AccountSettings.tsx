...
// ** Demo Tabs Imports
import TabAccount from 'src/pages/allModules/general/users/account-settings/TabAccount'

// import TabBilling from 'src/views/pages/account-settings/TabBilling'
import TabSecurity from 'src/pages/allModules/general/users/account-settings/TabSecurity'

import TabConnections from 'src/pages/allModules/general/users/account-settings/TabConnections'
import TabNotifications from 'src/pages/allModules/general/users/account-settings/TabNotifications'
