...
import { fetchDataById } from 'src/store/apps/general/department'
...
const DialogEditUserInfo = ({ itemId, openEdit, setOpenEdit }) => {
  ...
  const dataEdit = useSelector((state: RootState) => state.departments.dataById)
  const dataByIdLoading = useSelector((state: RootState) => state.departments.dataByIdLoading)
  ...
  return (
    ...
    >
      ...
      >
        Edit Department Information {itemId}
      </DialogTitle>
