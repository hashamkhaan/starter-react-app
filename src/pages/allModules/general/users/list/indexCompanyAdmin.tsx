...
import AddUserDrawerThisCompanyAdmin from './AddUserDrawer/thisCompanyAdmin'
...
import { fetchBranchesDropdowns, fetchDepartmentsDropdowns, fetchRolesDropdowns } from 'src/store/apps/users'
...
const UserList = ({ apiData }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      {customAbility.can([], ALL_COMPANIES_ADMIN_SUBJECT, ability) ? (
        <AddUserDrawerThisCompanyAdmin open={addUserOpen} toggle={toggleAddUserDrawer} />
      ) : null}
    </Grid>
  )
}
