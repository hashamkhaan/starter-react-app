        ...
        <Card>
          <CardContent>
            <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Typography variant='body2'>{`Total ${item.companyBranchesCount} Branches`}</Typography>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
              <Box sx={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column' }}>
                ...
                <Typography variant='body2'>{`${item.description}-${item.companyType.name}`}</Typography>

                <Typography
                  variant='body2'
                  component={Link}
                  sx={{ color: 'primary.main', textDecoration: 'none' }}
                  href={`/allModules/general/companies/view/overview?id=${item.id}`}
