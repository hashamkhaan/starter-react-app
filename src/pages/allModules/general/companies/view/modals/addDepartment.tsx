...
import { addNewDepartmentInBranchCompany, fetchSimpleDepartmentsDropdowns } from 'src/store/apps/general/company'
...
const DialogEditUserInfo = ({ open, handleClose, companyId, branchId }) => {
