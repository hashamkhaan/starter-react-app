...
const InvoiceListTable = ({ data, companyId, branchId }) => {
  // ** State
  ...
  return (
    <Card>
      ...
      />
      <AddDepartment open={open} handleClose={handleClose} companyId={companyId} branchId={branchId} />
      <DeletionDialog itemId={itemId} open={deletionDialogOpen} setOpen={setDeletionDialogOpen} companyId={companyId} />
