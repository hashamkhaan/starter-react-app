...
import { deleteDepartmentInCompanyBranch } from 'src/store/apps/shared/thisCompany/branch'
...
const DeletionDialog = ({ itemId, open, setOpen }) => {
  ...
  const handleSubmit = () => {
    ...
    dispatch(deleteDepartmentInCompanyBranch({ id: itemId, onSubmitSuccess, onSubmitError }))
  }
  const handleClose = () => {
    setOpen(false)
    setSubmitLoading(false)
